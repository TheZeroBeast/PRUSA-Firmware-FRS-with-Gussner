...
extern const char* const MSG_FR_SENS_INVERT_OFF_LANG_TABLE[1];
#define MSG_FR_SENS_INVERT_OFF LANG_TABLE_SELECT_EXPLICIT(MSG_FR_SENS_INVERT_OFF_LANG_TABLE, 0)
extern const char* const MSG_FR_SENS_INVERT_ON_LANG_TABLE[1];
#define MSG_FR_SENS_INVERT_ON LANG_TABLE_SELECT_EXPLICIT(MSG_FR_SENS_INVERT_ON_LANG_TABLE, 0)
