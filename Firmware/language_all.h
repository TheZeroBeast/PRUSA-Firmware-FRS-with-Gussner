...
extern const char* const MSG_FR_SENS_LANG_TABLE[1];
#define MSG_FR_SENS LANG_TABLE_SELECT_EXPLICIT(MSG_FR_SENS_LANG_TABLE, 0)
extern const char* const MSG_FR_SENS_ACTIVE_OFF_LANG_TABLE[1];
#define MSG_FR_SENS_ACTIVE_OFF LANG_TABLE_SELECT_EXPLICIT(MSG_FR_SENS_ACTIVE_OFF_LANG_TABLE, 0)
extern const char* const MSG_FR_SENS_ACTIVE_ON_LANG_TABLE[1];
#define MSG_FR_SENS_ACTIVE_ON LANG_TABLE_SELECT_EXPLICIT(MSG_FR_SENS_ACTIVE_ON_LANG_TABLE, 0)
extern const char* const MSG_FR_SENS_HIT_LANG_TABLE[1];
#define MSG_FR_SENS_HIT LANG_TABLE_SELECT_EXPLICIT(MSG_FR_SENS_HIT_LANG_TABLE, 0)
extern const char* const MSG_FR_SENS_INVERTING_OFF_LANG_TABLE[1];
#define MSG_FR_SENS_INVERTING_OFF LANG_TABLE_SELECT_EXPLICIT(MSG_FR_SENS_INVERTING_OFF_LANG_TABLE, 0)
extern const char* const MSG_FR_SENS_INVERTING_ON_LANG_TABLE[1];

extern const char* const MSG_FR_SENS_PU_OFF_LANG_TABLE[1];
#define MSG_FR_SENS_PU_OFF LANG_TABLE_SELECT_EXPLICIT(MSG_FR_SENS_PU_OFF_LANG_TABLE, 0)
extern const char* const MSG_FR_SENS_PU_ON_LANG_TABLE[1];
#define MSG_FR_SENS_PU_ON LANG_TABLE_SELECT_EXPLICIT(MSG_FR_SENS_PU_ON_LANG_TABLE, 0)

#define MSG_FR_SENS_INVERTING_ON LANG_TABLE_SELECT_EXPLICIT(MSG_FR_SENS_INVERTING_ON_LANG_TABLE, 0)
extern const char* const MSG_FR_SENS_OPEN_LANG_TABLE[1];
#define MSG_FR_SENS_OPEN LANG_TABLE_SELECT_EXPLICIT(MSG_FR_SENS_OPEN_LANG_TABLE, 0)
extern const char* const MSG_FR_SENS_SETTINGS_LANG_TABLE[1];
#define MSG_FR_SENS_SETTINGS LANG_TABLE_SELECT_EXPLICIT(MSG_FR_SENS_SETTINGS_LANG_TABLE, 0)
//FR_SENS
...
extern const char* const MSG_SDCARD_SETTINGS_LANG_TABLE[1];
#define MSG_SDCARD_SETTINGS LANG_TABLE_SELECT_EXPLICIT(MSG_SDCARD_SETTINGS_LANG_TABLE, 0)
